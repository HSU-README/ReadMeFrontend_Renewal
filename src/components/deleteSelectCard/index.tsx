...
export default function DeleteSelectCard({ data }: { data: DocumentType }) {
  ...
  return (
    ...
    >
      ...
      <Link to={`https://hsureadme.herokuapp.com/preview/${documentId}`} style={{ textDecoration: 'none', color: 'black', width: '300px' }}>
        ...
        <div className="top-info-container">
          <div className="hashtag-container">
            {docTags.map((tag: TagType) => (
              <Link to={`https://hsureadme.herokuapp.com/search?searchtag=${tag.name.slice(1)}`} style={{ textDecoration: 'none', color: 'black' }}>
