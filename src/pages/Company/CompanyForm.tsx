            ...
            <Container>
                <form>
                    ...
                    <div className="section">
                        ...
                        <div
                        className="inputCompanyName">{companyName}</div>
                    </div>
                    <div className="section">
                        ...
                        className="inputCompanyName">{contents}</div>
                    </div>
                    <div className="section">
                        <label className="sectionName">기술 스택</label>
                        <div
                        className="inputCompanyName">{tech}</div>
                    </div>
                    <div className="section">
                        <label className="sectionName">직무</label>
                        <div
                        className="inputCompanyName2">{duty}
                        </div>
                        <label className="sectionName">구분</label>
                        <div
                        className="inputCompanyName2">{career}
                        </div>
                    </div>
                    <div className="section">
                        <label className="sectionName">지역</label>
                        <div
                        className="inputCompanyName2">{location}
                        </div>
                        <label className="sectionName">연봉(월급)</label>
                        <div
                        className="inputCompanyName2">{salary} 만원
                        </div>
                    </div>
                    <div className="section">
                        ...
                        <a>
                            <div
                                className="inputCompanyName" style={{color:'blue'}}>
                                    {companyURL}
                            </div>
                        </a>
                    </div>
